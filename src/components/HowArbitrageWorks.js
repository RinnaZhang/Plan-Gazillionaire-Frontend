      ...
      <div className="flex flex-wrap justify-center gap-12 items-start">
        ...
        <div className="max-w-lg text-xl text-gray-300 leading-relaxed">
          ...
          <ul className="list-disc mt-4 ml-5">
            <li>On Kalshi, "No" is priced at <span className="text-blue-400">60¢</span>.</li>
            <li>On Polymarket, "Yes" is priced at <span className="text-pink-400">20¢</span>.</li>
          </ul>
          <p className="mt-6">
            You can bet <span className="text-blue-400">$60</span> on "No" at Kalshi and <span className="text-pink-400">$20</span> on "Yes" at Polymarket. Regardless of the outcome, your total payout will be $100.
          </p>
        </div>

        {/* Visual Comparison */}
        <div className="bg-[#162639] p-6 rounded-lg shadow-lg w-[300px]">
          <h3 className="text-center text-white text-lg mb-4">Example Comparison</h3>
